...
class MyCourseMicrolearningIndex extends StatefulWidget {
  @override
  _MyCourseMicrolearningIndexState createState() => _MyCourseMicrolearningIndexState();
}

class _MyCourseMicrolearningIndexState extends State<MyCourseMicrolearningIndex> {
...
super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        elevation: 0.0,
        centerTitle: true,
        title: Text('Tus Cursos Microlearning',style:(prefs.colorSecundario) ? TextStyle(color: Colors.grey):TextStyle(color: Colors.black)),
        // backgroundColor: Colors.purple[400],
        iconTheme:(prefs.colorSecundario) ? new IconThemeData(color: Colors.grey): new IconThemeData(color: Colors.black),
        backgroundColor:(prefs.colorSecundario) ? Colors.grey[850] : Color(0xFFEFEEEE),
        //  leading: IconButton(
  ...
  Widget _coursesLoad(BuildContext context) {
    ...
    return FutureBuilder(
      future: coursesProvider.courseForUserMicrolearning(),
      builder:
