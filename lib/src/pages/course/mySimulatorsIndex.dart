...
class MySimulatorsIndex extends StatefulWidget {
  @override
  _MySimulatorsIndexState createState() => _MySimulatorsIndexState();
}

class _MySimulatorsIndexState extends State<MySimulatorsIndex> {
...
super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        elevation: 0.0,
        centerTitle: true,
        title: Text('Tus Simuladores',style:(prefs.colorSecundario) ? TextStyle(color: Colors.grey):TextStyle(color: Colors.black)),
  ...
  Widget _coursesLoad(BuildContext context) {
    ...
    return FutureBuilder(
      future: coursesProvider.courseForUserSimulators(),
      builder:
